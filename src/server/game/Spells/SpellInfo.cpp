...
SpellInfo::SpellInfo(SpellEntry const* spellEntry)
{
    ...
    Attributes = spellEntry->Attributes & ~SPELL_ATTR0_ON_NEXT_SWING;
    AttributesEx = spellEntry->AttributesEx;
    AttributesEx2 = spellEntry->AttributesEx2;
    AttributesEx3 = spellEntry->AttributesEx3;
    AttributesEx4 = spellEntry->AttributesEx4 | SPELL_ATTR4_ALLOW_CAST_WHILE_CASTING;
    AttributesEx5 = spellEntry->AttributesEx5;
    AttributesEx6 = spellEntry->AttributesEx6;
    AttributesEx7 = spellEntry->AttributesEx7 & ~SPELL_ATTR7_RESET_SWING_TIMER_AT_SPELL_START;
    AttributesCu = 0;
